...
<div class="card shadow mb-4">
    ...
    <div class="card-body">
        <div class="table-responsive">
            <a href="{{ url('kamar/create') }}" class="btn btn-danger btn-circle btn-lg mb-3">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="{{ url('kamar/'.$item->id.'/edit') }}" class="btn btn-icon btn-warning mt-1"><i class="fas fa-pen"></i></a>
                            </td>
                    </tr>
                    @endforeach
                </tbody>
